...
import java.sql.*;
public class editben1 extends javax.swing.JFrame {
    ...
    private int benids;
    int i = 0;
    public editben1(int sss, int benid) {
        this.sssnum = sss;
        this.benids = benid;
        ...
        try {
            ...
            String query1 = "SELECT * FROM beneficiaries WHERE BenID = " + benids;
            String query2 = "SELECT BenID, YEAR(BenBirthday), MONTH(BenBirthday), DAY(BenBirthday) FROM beneficiaries WHERE BenID = " + benids;
            rs = st.executeQuery(query1);
            while (rs.next()) {
                int ssnum = rs.getInt("SSSNumber");
                int bid = rs.getInt("BenID");
                String name = rs.getString("BenName");
                String relationship = rs.getString("BenRelationship");
                jLabel1.setText(String.valueOf(ssnum));
                jLabel7.setText(String.valueOf(bid));
                jTextField1.setText(name);
                jTextField2.setText(relationship);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Edit Beneficiary Record Page");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            if(i == 0){
                String query1 = "UPDATE beneficiaries SET BenName = ?, BenBirthday = ?, BenRelationship = ? WHERE SSSNumber = " + sssnum + " AND BenID = " + benids;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editben1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editben1(0, 0).setVisible(true);
            }
        });
    }
