...
public class benerecord1 extends javax.swing.JFrame {
...
//                    System.out.println("View info" + row);
            ...
            jTable1.getColumnModel().getColumn(2).setCellRenderer(new TableActionCellRender1());
            jTable1.getColumnModel().getColumn(2).setCellEditor(new TableActionCellEditor1(event));
    ...
    private void initComponents() {
        ...
        setTitle("Beneficiaries Records Page");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SSS Number", "Name", "View Beneficiaries"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(benerecord1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new benerecord1().setVisible(true);
            }
        });
    }
