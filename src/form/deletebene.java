...
import java.sql.*;
public class deletebene extends javax.swing.JFrame {
    ...
    private int sssnum;
    private int ben;
    public deletebene(int sss, int benid) {
        this.sssnum = sss;
        this.ben = benid;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Delete Beneficiary Record Page");
        ...
        jLabel3.setText("beneficiary record?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String query = "DELETE FROM beneficiaries WHERE BenID = " + ben;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deletebene.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deletebene(0, 0).setVisible(true);
            }
        });
    }
